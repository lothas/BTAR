...
public class MyGLRenderer implements GLSurfaceView.Renderer {
    ...
    private void load3dObjects(){
        ...
        mTower = new AssetObj(mMainActivity, "tower2.obj","tower2.mtl");
        mCoin = new AssetObj(mMainActivity, "t2.obj","object2.mtl");
        mTest = new AssetObj(mMainActivity, "t2.obj","object2.mtl");       
    }
    ...
    public void drawCoinToWorld(GL10 gl, MarkerDetector mDetector){
		...
		float rotateOnZ = mDetector.getAngleFromXAxis(); //TODO rotate according to time;
		gl.glRotatef(rotateOnZ, 0, 0, 1);
		gl.glRotatef(rollAngle, (float)Math.cos(Math.toRadians(rotateOnZ)), -(float)Math.sin(Math.toRadians(rotateOnZ)), 0);
