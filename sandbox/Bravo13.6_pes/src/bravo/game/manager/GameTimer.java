...
public class GameTimer {
	...
	private void updateGame(int min, int sec, int tMilSec){
		...
		coinDelayUpdate(min, sec, tMilSec);
	}
	
	private void coinDelayUpdate(int min, int sec, int tMilSec) {
		if (tMilSec == 0){
			if(mMainActivity.mGameManager.getCoinCollectedDelay() == 1 ){
				mMainActivity.mGameManager.setCoinCollectedDelay(2);
			}else if(mMainActivity.mGameManager.getCoinCollectedDelay() == 2){
				mMainActivity.mGameManager.setCoinCollectedDelay(0);
			}
		}
