...
public class AssetObj {
	...
	public AssetObj(Context context) {
		AssetManager am = context.getAssets();
		InputStream is;
		try {
			is = am.open("cube1.obj");
			InputStream is2 = am.open("cube1.obj");
			myParser parser = new myParser(is,is2,3,0,0,0);
			parser.run();
			mFVertexBuffer = parser.mFVertexBuffer;
			mColorBuffer = parser.mColorBuffer;
			mIndexBuffer = parser.mIndexBuffer;
			mIndexBufferLength = parser.m_NumVertices;
	...
	public void draw(GL10 gl) {
	    ...
	    //----------------------------    
		gl.glDrawElements(GL11.GL_TRIANGLES, mIndexBufferLength,GL11.GL_UNSIGNED_BYTE, mIndexBuffer);
