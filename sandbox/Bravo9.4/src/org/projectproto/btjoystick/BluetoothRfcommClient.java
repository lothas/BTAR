...
import com.example.bravo.BravoBT;
...
public class BluetoothRfcommClient {
    ...
    private synchronized void setState(int state) {
        ...
        mHandler.obtainMessage(BravoBT.MESSAGE_STATE_CHANGE, state, -1).sendToTarget();
    }
    ...
    public synchronized void connected(BluetoothSocket socket, BluetoothDevice device) {
        ...
        Message msg = mHandler.obtainMessage(BravoBT.MESSAGE_DEVICE_NAME);
        Bundle bundle = new Bundle();
        bundle.putString(BravoBT.DEVICE_NAME, device.getName());
        msg.setData(bundle);
    ...
    public void write(byte[] out) {
        ...
        for (int index = 0; index < out.length; index++){
        	 Log.v(TAG, String.format("0x%20x", out[index]));
        	}
    ...
    private void connectionFailed() {
        ...
        Message msg = mHandler.obtainMessage(BravoBT.MESSAGE_TOAST);
        Bundle bundle = new Bundle();
        bundle.putString(BravoBT.TOAST, "Unable to connect device");
        msg.setData(bundle);
        mHandler.sendMessage(msg);
    }
    ...
    private void connectionLost() {
        ...
        Message msg = mHandler.obtainMessage(BravoBT.MESSAGE_TOAST);
        Bundle bundle = new Bundle();
        bundle.putString(BravoBT.TOAST, "Device connection was lost");
        msg.setData(bundle);
        mHandler.sendMessage(msg);
    }
    ...
    private class ConnectedThread extends Thread {
        ...
        public void run() {
            ...
            while (true) {
                try {
                    ...
                    mHandler.obtainMessage(BravoBT.MESSAGE_READ, bytes, -1, buffer)
                            .sendToTarget();
                } catch (IOException e) {
                    //
                    connectionLost();
        ...
        public void write(byte[] buffer) {
            try {
                ...
                mHandler.obtainMessage(BravoBT.MESSAGE_WRITE, -1, -1, buffer)
                        .sendToTarget();
            } catch (IOException e) {
                //
            }
